                    ...
                    {inbox.length ? inbox.map(message => {
                        return (
                            <div className={UserMessagePageCss.post} key={message._id}>
                                <div className={UserMessagePageCss.post}>Message is About~~{'>'} {message.post.title.toUpperCase()} {'<'}~~</div>
                                <div className={UserMessagePageCss.user}>Message is From ~~{'>'} {message.fromUser.username.toUpperCase()} {'<'}~~</div>
